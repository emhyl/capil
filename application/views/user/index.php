...
-->
    ...
    <body id="top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src=" <?= base_url('assets/user/') ?>images/slider/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src=" <?= base_url('assets/user/') ?>images/slider/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src=" <?= base_url('assets/user/') ?>images/slider/doctor-s-hand-holding-stethoscope-closeup.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="heroText d-flex flex-column justify-content-center">
                                ...
                                <p class="mb-4">Medic Care is a Bootstrap 5 Template provided by TemplateMo website. Credits go to FreePik and RawPixel for  <?= base_url('assets/user/') ?>images used in this template.</p>
                        ...
                        <div class="col-12">
                            ...
                            <div class="owl-carousel reviews-carousel">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src=" <?= base_url('assets/user/') ?>images/reviews/beautiful-woman-face-portrait-brown-background.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src=" <?= base_url('assets/user/') ?>images/reviews/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src=" <?= base_url('assets/user/') ?>images/reviews/portrait-british-woman.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src=" <?= base_url('assets/user/') ?>images/reviews/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg" class="img-fluid reviews-image" alt="">
        ...
        <!-- JAVASCRIPT FILES -->
        <script src="<?= base_url('assts/user') ?>/js/jquery.min.js"></script>
        <script src="<?= base_url('assts/user') ?>/js/bootstrap.bundle.min.js"></script>
        <script src="<?= base_url('assts/user') ?>/js/owl.carousel.min.js"></script>
        <script src="<?= base_url('assts/user') ?>/js/scrollspy.min.js"></script>
        <script src="<?= base_url('assts/user') ?>/js/custom.js"></script>
<!--
